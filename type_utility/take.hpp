...
namespace TypeUtility::Core {
  ...
  public:
    ...
    static constexpr auto call(Type_sequence<Ts...>, Nat<N>)
    {
      static_assert(
        count_types<Ts...>() >= N, "Expected a sufficient number of types");
  ...
  private:
    ...
    static constexpr auto aux(Type_sequence<>, Type_sequence<Us...>, Nat<0>)
    {
      return types<Us...>;
    }
  ...
  template<typename... Ts, size_t N>
  constexpr auto take(Type_sequence<Ts...>, Nat<N>)
  {
  ...
  public:
    ...
    static constexpr auto call(Integer_sequence<I, xs...>, Nat<N>)
    {
  ...
  template<typename I, I... xs, size_t N>
  constexpr auto take(Integer_sequence<I, xs...>, Nat<N>)
  {
    return Take_integers::call(integers<I, xs...>, nat<N>);
  }

  template<size_t... xs>
  constexpr auto index_to_integer_sequence(index_sequence<xs...>)
  {
    return integers<size_t, xs...>;
  }

  template<size_t... xs>
  constexpr auto integer_to_index_sequence(Integer_sequence<size_t, xs...>)
  {
    return index_sequence<xs...>();
  }

  template<size_t... xs, size_t N>
  constexpr auto take(index_sequence<xs...>, Nat<N>)
  {

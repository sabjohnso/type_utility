...
namespace TypeUtility::Core {
  ...
  constexpr bool ismember(Integer_set<T, xs...>, Integer<T, x>)
  {
    return ismember(integers<T, xs...>, integer<T, x>);
  }

  template<typename T, T... xs>
  constexpr auto integer_set_validate(Integer_set<T, xs...>)
  {
    static_assert(
      Are_unique_integers<T, xs...>::value, "Expected unique integers");
    return integer_set<T, xs...>;
  }

  template<typename T, T... xs, T x>
  constexpr auto integer_set_add(Integer_set<T, xs...>, Integer<T, x>)
  {
    return cond<ismember(integers<T, xs...>, integer<T, x>)>(
      integer_set<T, xs...>, integer_set<T, x, xs...>);
  }

  template<typename T, T... xs, T y, T... ys>
  constexpr auto integer_set_union(
    Integer_set<T, xs...>,
    Integer_set<T, y, ys...>)
  {
  ...
  template<typename T, T... xs>
  constexpr auto integer_set_union(Integer_set<T, xs...>, Integer_set<T>)
  {
    return integer_set<T, xs...>;
  }

  template<typename T, T... xs, T... ys>
  constexpr auto integer_set_intersection(
    Integer_set<T, xs...>,
    Integer_set<T, ys...>)
  {
  ...
  constexpr auto integer_set_intersection_aux(
    Integer_set<T, x, xs...>,
    Integer_set<T, ys...>,
    Integer_set<T, zs...>)
  {
    return integer_set_intersection_aux(
      ...
      cond<ismember(integers<T, ys...>, integer<T, x>)>(
        integer_set<T, x, zs...>, integer_set<T, zs...>));
  }
  ...
  template<typename T, T... xs, T y, T... ys>
  constexpr bool issubset(Integer_set<T, xs...>, Integer_set<T, y, ys...>)
  {
  ...
  template<typename T, T... xs>
  constexpr bool issubset(Integer_set<T, xs...>, Integer_set<T>)
  {
    return true;
  }
  ...
  template<typename T, T... ys, T... zs>
  constexpr auto
  integer_set_difference_aux(
    Integer_set<T>,
    Integer_set<T, ys...>,
    Integer_set<T, zs...> accum)
  {
    return accum;
  }
  ...
  template<typename T, T... xs, T... ys>
  constexpr auto
  integer_set_symmetric_difference(
    Integer_set<T, xs...> xset,
    Integer_set<T, ys...> yset)
  {
    return integer_set_intersection(
      integer_set_difference(xset, yset), integer_set_difference(yset, xset));
  }

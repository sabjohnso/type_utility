...
namespace TypeUtility::Core
{
    ...
    public:
      ...
      /** 
       * @brief checks if every bit in the type's object representation contributes to its value 
       */
      static constexpr bool
      ...
      /** 
       * @brief checks if objects of a type can be swapped with objects of same or different type 
       */
      template< typename U >
      static constexpr bool
      ...
      /**  
       * @brief checks if a type can be invoked (as if by std::invoke) with the given argument types 
       */
      template< typename ... Ts >
      static constexpr bool
    ...
    /**
     * @brief Inject a printed representation of a type proxy for a unicode character
     * (char16_t) to an output Stream
     */
    template<typename Stream>
    Stream&
    ...
    /**
     * @brief Inject a printed representation of a type proxy for a unicode character type
     * (char32_t) to an output Stream
     */
    template<typename Stream>
    Stream&
    ...
    operator <<(Stream& os, Type<long long>){
     ...
     /**
     * @brief Inject a prunsigned shorted representation of a type proxy for unsigned short
     * to an output Stream
     */
    template<typename Stream>
    Stream&
    ...
    /**
     * @brief Inject a prunsigned longed representation of a type proxy for unsigned long
     * to an output Stream
     */
    template<typename Stream>
    Stream&
    ...
    /**
     * @brief Inject a prunsigned long longed representation of a type proxy for unsigned long long
     * to an output Stream
     */
    template<typename Stream>
    Stream&
    ...
    /**
     * @brief Inject a prlong doubleed representation of a type proxy for long double
     * to an output Stream
     */
    template<typename Stream>
    Stream&

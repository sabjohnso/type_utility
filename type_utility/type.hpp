...
#define TYPE_UTILITY_PRINTABLE_TYPE( name )	\
    ...
    TYPE_UTILITY_PRINTABLE_TYPE( unsigned char );
    TYPE_UTILITY_PRINTABLE_TYPE( signed char );
    TYPE_UTILITY_PRINTABLE_TYPE( wchar_t );
    TYPE_UTILITY_PRINTABLE_TYPE( char16_t );
    TYPE_UTILITY_PRINTABLE_TYPE( char32_t );
    
    TYPE_UTILITY_PRINTABLE_TYPE( short );
    TYPE_UTILITY_PRINTABLE_TYPE( int );
    TYPE_UTILITY_PRINTABLE_TYPE( long );
    TYPE_UTILITY_PRINTABLE_TYPE( long long );

    TYPE_UTILITY_PRINTABLE_TYPE( unsigned short );
    TYPE_UTILITY_PRINTABLE_TYPE( unsigned);
    TYPE_UTILITY_PRINTABLE_TYPE( unsigned long );
    TYPE_UTILITY_PRINTABLE_TYPE( unsigned long long );

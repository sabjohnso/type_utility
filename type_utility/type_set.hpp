...
namespace TypeUtility::Core {
  ...
  constexpr bool ismember(Type_set<Ts...>, Type<T>)
  {
  ...
  constexpr auto cond(Pass, Fail)
  {
    return conditional_t<test, Pass, Fail>{};
  }

  template<typename... Ts, typename T>
  constexpr auto type_set_add(Type_set<Ts...>, Type<T>)
  {
  ...
  template<typename... Ts>
  constexpr auto type_set_intersection(Type_set<Ts...>, Type_set<>)
  {
    return type_set<Ts...>;
  }

  template<typename... Ts, typename U, typename... Us>
  constexpr auto type_set_intersection(Type_set<Ts...>, Type_set<U, Us...>)
  {
    return type_set_intersection(
      type_set_add(type_set<Ts...>, type<U>), Type_set<Us...>{});
  }
